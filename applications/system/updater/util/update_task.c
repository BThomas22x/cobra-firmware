...
static const char* update_task_stage_descr[] = {
    ...
    [UpdateTaskStageReadManifest] = "Loading Cobra manifest",
    [UpdateTaskStageValidateDFUImage] = "Checking DFU file",
    [UpdateTaskStageFlashWrite] = "Writing Cobra Firmware",
    [UpdateTaskStageFlashValidate] = "Checking flash",
    ...
    [UpdateTaskStageResourcesUpdate] = "Updating Cobra resources",
    [UpdateTaskStageSplashscreenInstall] = "Installing Cobra splashscreen",
